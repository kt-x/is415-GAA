...
Ho = The distribution of functional in Osun, Nigeria are randomly distributed.

H1= The distribution of functional in Osun, Nigeria are NOT randomly distributed.
...
```{r}
func_osun.csr <- envelope(wp_osun_ppp_func, Gest, nsim = 999)
```
