...
| KELURAHAN              | Ward / Villages / Communities |
...
#select & filter
jkt_jul2021 <- jkt_jul2021 |> 
  select(2:4, 9)

#Reference to https://sparkbyexamples.com/r-programming/rename-column-in-r/
#rename
colnames(jkt_jul2021)[1] ="City"
colnames(jkt_jul2021)[2] ="Sub_District"
colnames(jkt_jul2021)[3] ="Ward"
colnames(jkt_jul2021)[4] ="Total_vaccine_given_jul2021"
...
#select & filter
jkt_aug2021 <- jkt_aug2021 |> 
  select(2:4, 9)

#Reference to https://sparkbyexamples.com/r-programming/rename-column-in-r/
#rename
colnames(jkt_aug2021)[1] ="City"
colnames(jkt_aug2021)[2] ="Sub_District"
colnames(jkt_aug2021)[3] ="Ward"
colnames(jkt_aug2021)[4] ="Total_vaccine_given_aug2021"
...
#select & filter
jkt_sept2021 <- jkt_sept2021 |> 
  select(2:4, 9)

#Reference to https://sparkbyexamples.com/r-programming/rename-column-in-r/
#rename
colnames(jkt_sept2021)[1] ="City"
colnames(jkt_sept2021)[2] ="Sub_District"
colnames(jkt_sept2021)[3] ="Ward"
colnames(jkt_sept2021)[4] ="Total_vaccine_given_sept2021"
...
#select & filter
jkt_oct2021 <- jkt_oct2021 |> 
  select(2:4, 9)

#Reference to https://sparkbyexamples.com/r-programming/rename-column-in-r/
#rename
colnames(jkt_oct2021)[1] ="City"
colnames(jkt_oct2021)[2] ="Sub_District"
colnames(jkt_oct2021)[3] ="Ward"
colnames(jkt_oct2021)[4] ="Total_vaccine_given_oct2021"
...
#select & filter
jkt_nov2021 <- jkt_nov2021 |> 
  select(2:4, 9)

#Reference to https://sparkbyexamples.com/r-programming/rename-column-in-r/
#rename
colnames(jkt_nov2021)[1] ="City"
colnames(jkt_nov2021)[2] ="Sub_District"
colnames(jkt_nov2021)[3] ="Ward"
colnames(jkt_nov2021)[4] ="Total_vaccine_given_nov2021"
...
#select & filter
jkt_dec2021 <- jkt_dec2021 |> 
  select(2:4, 9)

#Reference to https://sparkbyexamples.com/r-programming/rename-column-in-r/
#rename
colnames(jkt_dec2021)[1] ="City"
colnames(jkt_dec2021)[2] ="Sub_District"
colnames(jkt_dec2021)[3] ="Ward"
colnames(jkt_dec2021)[4] ="Total_vaccine_given_dec2021"
...
#select & filter
jkt_jan2022 <- jkt_jan2022 |> 
  select(2:4, 9)

#Reference to https://sparkbyexamples.com/r-programming/rename-column-in-r/
#rename
colnames(jkt_jan2022)[1] ="City"
colnames(jkt_jan2022)[2] ="Sub_District"
colnames(jkt_jan2022)[3] ="Ward"
colnames(jkt_jan2022)[4] ="Total_vaccine_given_jan2022"
...
#select & filter
jkt_feb2022 <- jkt_feb2022 |> 
  select(2:4, 9)

#Reference to https://sparkbyexamples.com/r-programming/rename-column-in-r/
#rename
colnames(jkt_feb2022)[1] ="City"
colnames(jkt_feb2022)[2] ="Sub_District"
colnames(jkt_feb2022)[3] ="Ward"
colnames(jkt_feb2022)[4] ="Total_vaccine_given_feb2022"
...
#select & filter
jkt_mar2022 <- jkt_mar2022 |> 
  select(2:4, 9)

#Reference to https://sparkbyexamples.com/r-programming/rename-column-in-r/
#rename
colnames(jkt_mar2022)[1] ="City"
colnames(jkt_mar2022)[2] ="Sub_District"
colnames(jkt_mar2022)[3] ="Ward"
colnames(jkt_mar2022)[4] ="Total_vaccine_given_mar2022"
...
#select & filter
jkt_apr2022 <- jkt_apr2022 |> 
  select(2:4, 9)

#Reference to https://sparkbyexamples.com/r-programming/rename-column-in-r/
#rename
colnames(jkt_apr2022)[1] ="City"
colnames(jkt_apr2022)[2] ="Sub_District"
colnames(jkt_apr2022)[3] ="Ward"
colnames(jkt_apr2022)[4] ="Total_vaccine_given_apr2022"
...
#select & filter
jkt_may2022 <- jkt_may2022 |> 
  select(2:4, 9)

#Reference to https://sparkbyexamples.com/r-programming/rename-column-in-r/
#rename
colnames(jkt_may2022)[1] ="City"
colnames(jkt_may2022)[2] ="Sub_District"
colnames(jkt_may2022)[3] ="Ward"
colnames(jkt_may2022)[4] ="Total_vaccine_given_may2022"
...
#select & filter
jkt_jun2022 <- jkt_jun2022 |> 
  select(2:4, 9)

#Reference to https://sparkbyexamples.com/r-programming/rename-column-in-r/
#rename
colnames(jkt_jun2022)[1] ="City"
colnames(jkt_jun2022)[2] ="Sub_District"
colnames(jkt_jun2022)[3] ="Ward"
colnames(jkt_jun2022)[4] ="Total_vaccine_given_jun2022"
